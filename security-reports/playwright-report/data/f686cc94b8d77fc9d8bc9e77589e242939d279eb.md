...
- Name: auth-gate.spec.ts >> Admin route auth gate >> clicking go-home on 403 page navigates to /
- Location: tests/auth-gate.spec.ts:55:3
      ...
      - generic [ref=e30]:
        ...
        - generic [ref=e32]:
          ...
          - generic [ref=e39]:
            ...
            - generic [ref=e42]: a0ba84ea998f55d8
    - img [ref=e44]
```
