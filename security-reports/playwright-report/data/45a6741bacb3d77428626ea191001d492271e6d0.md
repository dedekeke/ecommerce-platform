...
- Name: golden-path.spec.ts >> Golden path: product list → cart → checkout → confirmation >> cart page shows added item and Proceed to Checkout button
- Location: tests/golden-path.spec.ts:54:3
