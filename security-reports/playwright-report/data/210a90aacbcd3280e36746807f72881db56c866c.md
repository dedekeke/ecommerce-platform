...
- Name: cart-edge-cases.spec.ts >> Cart edge cases >> quantity stepper decrease is disabled when quantity is 1
- Location: tests/cart-edge-cases.spec.ts:43:3
...
Locator: getByRole('button', { name: /decrease quantity/i })
Expected: disabled
Timeout: 8000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /decrease quantity/i })
