...
- Name: cart-edge-cases.spec.ts >> Cart edge cases >> empty cart shows empty state message and not a checkout button
- Location: tests/cart-edge-cases.spec.ts:13:3
