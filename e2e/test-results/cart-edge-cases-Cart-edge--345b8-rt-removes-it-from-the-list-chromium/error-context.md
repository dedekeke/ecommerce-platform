...
- Name: cart-edge-cases.spec.ts >> Cart edge cases >> remove item from cart removes it from the list
- Location: tests/cart-edge-cases.spec.ts:60:3
...
Locator: getByText('Test Product')
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for getByText('Test Product')
