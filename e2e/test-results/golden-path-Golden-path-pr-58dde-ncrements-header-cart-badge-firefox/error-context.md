...
- Name: golden-path.spec.ts >> Golden path: product list → cart → checkout → confirmation >> add to cart increments header cart badge
- Location: tests/golden-path.spec.ts:41:3
