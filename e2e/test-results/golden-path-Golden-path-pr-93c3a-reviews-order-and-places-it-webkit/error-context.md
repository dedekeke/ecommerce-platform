...
- Name: golden-path.spec.ts >> Golden path: product list → cart → checkout → confirmation >> full checkout flow fills address, payment, reviews order and places it
- Location: tests/golden-path.spec.ts:85:3
      ...
      - generic [ref=e30]:
        ...
        - generic [ref=e32]:
          ...
          - generic [ref=e39]:
            ...
            - generic [ref=e42]: a0ba857a295290f1
    - img [ref=e44]
```
