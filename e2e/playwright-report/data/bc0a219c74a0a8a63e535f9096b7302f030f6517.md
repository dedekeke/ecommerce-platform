...
- Name: golden-path.spec.ts >> Golden path: product list → cart → checkout → confirmation >> address form validates required fields on blur
- Location: tests/golden-path.spec.ts:75:3
      ...
      - generic [ref=e30]:
        ...
        - generic [ref=e32]:
          ...
          - generic [ref=e39]:
            ...
            - generic [ref=e42]: a0ba853a7d591ed9
    - img [ref=e44]
```
