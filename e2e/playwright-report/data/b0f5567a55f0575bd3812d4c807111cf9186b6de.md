...
- Name: auth-gate.spec.ts >> Admin route auth gate >> /admin/orders shows 403 for unauthenticated user
- Location: tests/auth-gate.spec.ts:36:3
      ...
      - generic [ref=e30]:
        ...
        - generic [ref=e32]:
          ...
          - generic [ref=e39]:
            ...
            - generic [ref=e42]: a0ba84e65adb5ff8
    - img [ref=e44]
```
