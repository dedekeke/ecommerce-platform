...
VALUES
    ('WELCOME10', 'Welcome 10% Off', 'Get 10% off on your first purchase', 'PERCENTAGE', 10.00, 50.00, NULL, 0, '2024-01-01 00:00:00', '2025-12-31 23:59:59', TRUE, NOW(), NOW()),
    ('SAVE20', 'Save 20%', 'Get 20% off on purchases over $100', 'PERCENTAGE', 20.00, 100.00, 1000, 0, '2024-01-01 00:00:00', '2025-12-31 23:59:59', TRUE, NOW(), NOW()),
    ('FIXED50', 'Fixed $50 Off', 'Get $50 off on purchases over $200', 'FIXED_AMOUNT', 50.00, 200.00, 500, 0, '2024-01-01 00:00:00', '2025-12-31 23:59:59', TRUE, NOW(), NOW());
