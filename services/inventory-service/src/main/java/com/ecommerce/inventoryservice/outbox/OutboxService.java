 ...
 * {@code @Transactional} method that mutates the aggregate (Inventory, etc.).
 * The outbox row therefore commits atomically with the aggregate row — no
...
public class OutboxService {
     ...
     *
     * @param aggregateType domain aggregate label (e.g. {@code "Inventory"})
     * @param aggregateId   aggregate primary key for partition routing
     * @param eventType     business event name (e.g. {@code "STOCK_LOW_DETECTED"})
